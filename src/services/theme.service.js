...
function sanitizeConfig(config = {}) {
  ...
  return {
    ...
    glowColor1: isValidCssValue(config.glowColor1) ? config.glowColor1 : 'rgba(220,38,38,0.12)',
    glowColor2: isValidCssValue(config.glowColor2) ? config.glowColor2 : 'rgba(220,38,38,0.10)',
